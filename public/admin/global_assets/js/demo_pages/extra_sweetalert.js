    ...
    var _componentSweetAlert = function() {
        ...
        $('#sweet_image').on('click', function() {
            swalInit({
                ...
                imageUrl: 'https://getbootstrap.com/docs/4.1//admin/assets/img/bootstrap-stack.png',
                imageWidth: 260
            });
        });
        ...
        $('#sweet_bg').on('click', function() {
            swalInit({
                ...
                background: '#fff url(../../../..//admin/global_assets//admin/images/backgrounds/seamless.png) repeat'
            });
        });
