...
var AlpacaAdvanced = function() {
    ...
    var _componentAlpacaAdvanced = function() {
        ...
        $('#alpaca-option-tree-connector').alpaca({
            schemaSource: '../../../..//admin/global_assets/demo_data/alpaca/optiontree-custom-schema.json',
            optionsSource: '../../../..//admin/global_assets/demo_data/alpaca/optiontree-custom-options.json',
            options: {
                focus: false
            }
        });
